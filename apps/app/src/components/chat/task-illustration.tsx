...
export function TaskIllustration({ kind }: { kind: TaskIllustrationKind }) {
  ...
  return (
    <svg aria-hidden="true" viewBox="0 0 80 64" fill="none" className="lw-task-illustration">
      <defs>
        <linearGradient id={gradientId} x1="24" y1="8" x2="55" y2="58" gradientUnits="userSpaceOnUse">
          <stop stopColor="var(--lw-surface)" />
          <stop offset="1" stopColor="var(--lw-sunken)" />
        </linearGradient>
      </defs>
      ...
      <path d="M29 18H43" stroke="var(--lw-text-secondary)" strokeWidth="2" strokeLinecap="round" />
      {kind === "grid" ? (
        <>
          ...
          <rect x="29" y="26" width="24" height="6" rx="2" fill="var(--lw-text-tertiary)" opacity=".16" />
          <path d="m47 43 1.5 1.5 2.5-3" stroke="var(--lw-text-secondary)" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" />
        </>
      ) : kind === "redline" ? (
        <>
          <path d="M29 27H52M29 33H46M29 45H42" stroke="var(--lw-border-strong)" strokeWidth="2" strokeLinecap="round" />
          <rect x="27" y="36" width="28" height="6" rx="2" fill="var(--lw-text-tertiary)" opacity=".18" />
          <path d="M30 39H49" stroke="var(--lw-text-secondary)" strokeWidth="1.2" strokeLinecap="round" />
          <path d="m48 51 3.5-.8L65 36.7l-2.7-2.8L49 47.5 48 51Z" fill="var(--lw-surface)" stroke="var(--lw-text-secondary)" strokeLinejoin="round" />
          <path d="m59.5 37 2.7 2.8" stroke="var(--lw-text-secondary)" />
        </>
      ) : (
        <>
          ...
          <path d="M42 47H60M42 51H54" stroke="var(--lw-text-secondary)" strokeWidth="1.5" strokeLinecap="round" />
        </>
      )}
    </svg>
  )
