...
export type ClaudePluginImportModalProps = {
  open: boolean;
  onClose: () => void;
  onPreview: (url: string) => Promise<LegalworkClaudePluginPreview>;
...
type ModalState = {
  url: string;
  preview: LegalworkClaudePluginPreview | null;
...
type ModalAction =
  | Partial<ModalState>
  | "reset"
  | { kind: "preview-success"; url: string; preview: LegalworkClaudePluginPreview };
