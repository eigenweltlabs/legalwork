...
export function MailRoute() {
    ...
    useEffect(() => { const controller = new AbortController(); void resolveLegalworkConnection().then(connection => { if (!controller.signal.aborted)
