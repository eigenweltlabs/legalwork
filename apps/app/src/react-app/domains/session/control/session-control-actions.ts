...
type SessionControlWorkspace = LegalworkWorkspaceInfo & {
...
export function useSessionControlActions(input: UseSessionControlActionsInput) {
  ...
  }), [navigateToSessionRoot, legalworkClient, refreshRouteState, selectedSessionId, sessionsByWorkspaceId, workspaces]);
