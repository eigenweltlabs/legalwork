...
export type ExtensionDetailModalProps = {
  ...
  /** Open a vendor partner/request-access program for gated connectors that cannot self-connect yet. */
...
const fallbackUiControlCommand = ["npx", "-y", "legalwork-ui-mcp"];
      ...
      >
        <DialogHeader>
          <div className="flex min-w-0 items-start gap-4">
            ...
            <div className="relative shrink-0">
              ...
              {connected ? (
                <div className="absolute -bottom-0.5 -right-0.5 flex size-5 items-center justify-center rounded-full border-2 border-dls-surface bg-emerald-9">
            ...
            <div className="min-w-0 flex flex-col gap-1 justify-center self-stretch">
              ...
              <DialogDescription className="flex flex-wrap items-center gap-2">
                ...
                {preview ? (
                  <span className="rounded-md bg-[rgba(var(--dls-accent-rgb),0.1)] px-1.5 py-0.5 text-[10px] font-medium text-dls-accent">
                    Preview
                  </span>
                ) : null}
              </DialogDescription>
              ...
              <CardContent>
                <div className="space-y-2">
                  ...
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span className={cn("font-medium", connected ? "text-emerald-11" : "text-muted-foreground")}>
                      {connected
        ...
        <DialogFooter className="shrink-0 flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex flex-col-reverse gap-2 sm:flex-row sm:justify-end">
            ...
            {!connected && !onConnect && onRequestAccess ? (
            ...
            <Table className="text-xs">
              <TableBody>
                ...
                <TableRow className="*:border-border hover:bg-transparent [&>:not(:last-child)]:border-r">
                  ...
                  <TableCell className="py-2 whitespace-normal">
                    <span className="font-mono text-xs break-all">LEGALWORK_UI_CONTROL_DISCOVERY=/path/to/legalwork-ui-control.json</span>
                  </TableCell>
                </TableRow>
