...
export function DocumentIcon({ kind, className, ...props }: DocumentIconProps) {
  ...
  return (
    ...
    >
      ...
      <g stroke="var(--lw-text-primary, #252529)" strokeWidth="1.1" strokeLinecap="round" strokeLinejoin="round">
        {kind === "sheet" ? (
          <><rect x="7" y="11" width="9" height="6" rx=".6" /><path d="M7 13.5h9M10.5 11v6" /></>
        ) : kind === "image" ? (
          <><rect x="7" y="10.5" width="9" height="7" rx=".8" /><path d="m7 16 2.7-2.7 2.1 2.1 1.4-1.4 2.8 2.8" /><circle cx="13.5" cy="12.5" r=".55" fill="var(--lw-text-primary, #252529)" stroke="none" /></>
        ) : kind === "html" ? (
