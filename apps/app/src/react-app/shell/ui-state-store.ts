...
export const PERSISTED_UI_STATE_KEY = "legalwork:ui-state:v1";
const SIDEBAR_COOKIE_NAME = "sidebar_state";
const LEGACY_WORKSPACE_LEFT_SIDEBAR_WIDTH_KEY = "legalwork.workspace-shell.left-width.v1";
...
function syncApplicationMenuVisible(visible: boolean): void {
  void globalThis.window?.__LEGALWORK_ELECTRON__?.invokeDesktop?.("__setApplicationMenuVisible", visible);
}
