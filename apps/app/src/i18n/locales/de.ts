...
const de: Record<string, string> = {
  ...
  "onboarding_office.install_one": "{app}-Add-in installieren",
  "onboarding_office.install_all": "Office-Add-ins installieren",
  ...
  "onboarding_audio.enable": "Transkription einschalten",
  "onboarding_audio.ready": "Bereit — drücke {shortcut} zum Diktieren",
  "onboarding_audio.ready_generic": "Bereit",
  "onboarding_audio.mic_waiting": "Erlaube den Mikrofonzugriff im System-Dialog…",
  "onboarding_audio.mic_denied": "Der Mikrofonzugriff ist deaktiviert.",
  "onboarding_audio.mic_open_settings": "Systemeinstellungen öffnen",
  "onboarding_audio.preparing": "On-Device-Modell wird vorbereitet…",
