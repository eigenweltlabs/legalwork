...
const de: Record<string, string> = {
  ...
  "recorder.stealth_active": "Tarnmodus — die App ist mattschwarz und in Bildschirmfreigaben unsichtbar, solange aufgenommen wird.",
  "recorder.transcriber_error": "Fehler der Transkriptions-Engine:",
  "recorder.rename": "Umbenennen",
  "recorder.context_inject_header": "Live-Transkript des Gesprächs (lokal auf dem Gerät aufgenommen). Nutze es als Kontext für das Folgende:",
  "recorder.context_inject_empty": "Es wurde noch nichts transkribiert.",
  "recorder.context_inject_no_session": "Öffne einen Chat-Workspace, um das Transkript zu seinem Kontext hinzuzufügen.",
  "stealth.recording_locally": "Nimmt lokal auf",
  "composer.insert_live_transcript": "Gespräch hinzufügen",
  "composer.insert_live_transcript_hint": "Live-Transkript des Gesprächs im Hintergrund zum Kontext dieses Chats hinzufügen",
  "composer.insert_live_transcript_done": "Gesprächstranskript zum Kontext hinzugefügt",
