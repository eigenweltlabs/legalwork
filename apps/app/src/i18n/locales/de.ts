...
const de: Record<string, string> = {
  ...
  "word_addin.no_workspaces": "Noch keine Workspaces. Öffne ein in einem Ordner gespeichertes Dokument, um hier einen zu erstellen, oder füge einen Workspace in der LegalWork-App hinzu.",
  "word_addin.file_folder_hint": "Der Ordner dieses Dokuments ist noch kein Workspace.",
  "word_addin.create_in_file_folder": "Workspace in „{folder}“ erstellen",
