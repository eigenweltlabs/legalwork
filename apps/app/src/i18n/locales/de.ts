...
const de: Record<string, string> = {
  ...
  "benchmark.analytics_empty_hint": "Starte ein Eval, um die Modell-Leistung über Aufgaben und Rechtsgebiete hinweg zu vergleichen.",
  ...
  "benchmark.empty_runs":
    "Noch keine Eval-Läufe. Erstelle einen, um deine verbundenen Modelle an juristischen Aufgaben zu vergleichen.",
  ...
  "benchmark.no_models_connected": "Verbinde zuerst einen KI-Anbieter, um Evals auszuführen.",
  ...
  "benchmark.transcript_readonly": "Schreibgeschützte Eval-Session — der Agent hat diese Aufgabe autonom bearbeitet.",
  ...
  "premium_upsell.eu_body": "50 € KI-Nutzung pro Sitzplatz und Monat inklusive, auf EU-Infrastruktur, die keine Prompts oder Ausgaben speichert.",
  ...
  "onboarding_office.cert_hint":
    "Dein Computer fragt einmalig nach, um dem lokalen Add-in-Zertifikat zu vertrauen.",
  "onboarding_office.restart_note": "Starte die Office-App neu, dann erscheint es im Menüband.",
  "onboarding_office.panel_eyebrow": "In deinen Werkzeugen",
  "onboarding_office.panel_title": "Der Agent, direkt neben deinem Dokument.",
  ...
  "onboarding_audio.ready": "Bereit — drücke {shortcut} zum Diktieren",
  "onboarding_audio.continue_background": "Im Hintergrund fortsetzen",
  "onboarding_audio.background_note": "Das Sprachmodell lädt weiter, während du arbeitest.",
  "onboarding_audio.ready_generic": "Bereit",
  "onboarding_audio.sample_speaker1": "Sprecher 1",
  "onboarding_audio.sample_line1": "Wir sollten die Haftungsobergrenze in Ziffer 8.2 vor der Unterschrift nachschärfen.",
  "onboarding_audio.sample_speaker2": "Sprecher 2",
  "onboarding_audio.sample_line2": "Einverstanden — und der Freistellungs-Carve-out muss zum Rahmenvertrag passen.",
  ...
  "onboarding_audio.panel_title": "Dein Audio verlässt diesen Rechner nicht.",
  "onboarding_audio.panel_footer": "Läuft lokal · Privat · Deine Daten",
