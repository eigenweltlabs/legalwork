...
const de: Record<string, string> = {
  ...
  "recorder.tier_premium_unlock_hint": "Das Premium-Transkriptionsmodell ist Teil eines kostenpflichtigen Plans. Es wird automatisch freigeschaltet, sobald Ihr Plan aktiv ist.",
