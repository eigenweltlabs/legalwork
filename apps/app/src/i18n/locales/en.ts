...
export default {
  ...
  "benchmark.onboarding_headline": "Benchmark your models on legal work",
  ...
  "benchmark.tab_runs": "Benchmark runs",
  ...
  "benchmark.analytics_empty_hint": "Run a benchmark to compare model performance across tasks and practice areas.",
  ...
  "benchmark.models_title": "Models to benchmark",
  "benchmark.new_run": "New benchmark",
  "benchmark.no_models_connected": "Connect an AI provider first to run benchmarks.",
  ...
  "benchmark.transcript_readonly": "Read-only benchmark session — the agent ran this task autonomously.",
  ...
  "tool_permissions.tool_bash": "Shell commands",
  ...
  "tool_permissions.bash_rules_title": "Shell command rules",
  "tool_permissions.bash_rules_desc": "Set what happens for specific shell commands. Rules use patterns — for example, git * covers every git command.",
  ...
  "tool_permissions.rule_wildcard_reserved": "Use “Shell commands” above to control what happens for all commands.",
