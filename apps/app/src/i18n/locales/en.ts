...
export default {
  ...
  "word_addin.no_workspaces": "No workspaces yet. Open a document saved inside a folder to create one here, or add a workspace in the LegalWork app.",
  "word_addin.file_folder_hint": "This document's folder isn't a workspace yet.",
  "word_addin.create_in_file_folder": "Create workspace in “{folder}”",
