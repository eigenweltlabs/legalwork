...
export default {
  ...
  "composer.insert_live_transcript": "Add call",
  "composer.insert_live_transcript_hint": "Add the live call transcript to this chat's context in the background",
  "composer.insert_live_transcript_done": "Call transcript added to context",
  "composer.steer": "Send",
  ...
  "recorder.context_inject_header": "Live call transcript (recorded locally, on-device). Use it as context for what follows:",
  "recorder.context_inject_empty": "Nothing has been transcribed yet.",
  "recorder.context_inject_no_session": "Open a chat workspace to add the transcript to its context.",
  ...
  "recorder.stealth_active": "Stealth mode — the app is matte black and hidden from screen shares while recording.",
