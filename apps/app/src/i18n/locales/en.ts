...
export default {
  ...
  "premium_upsell.eu_body": "€50 of Eigenwelt Model API usage included per seat each month, on EU-resident infrastructure that keeps no prompts or outputs.",
  ...
  "onboarding_office.install_one": "Install {app} add-in",
  "onboarding_office.install_all": "Install Office add-ins",
  ...
  "onboarding_audio.enable": "Turn on transcription",
  "onboarding_audio.ready": "Ready — press {shortcut} to dictate",
  "onboarding_audio.ready_generic": "Ready",
  "onboarding_audio.mic_waiting": "Allow microphone access in the system prompt…",
  "onboarding_audio.mic_denied": "Microphone access is turned off.",
  "onboarding_audio.mic_open_settings": "Open System Settings",
  "onboarding_audio.preparing": "Preparing the on-device model…",
