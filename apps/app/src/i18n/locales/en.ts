...
export default {
  ...
  "onboarding_setup.eyebrow": "Last step · Your tools",
  "onboarding_setup.title": "What should LegalWork do for you?",
  "onboarding_setup.subtitle":
    "Turn on what you'll actually use — LegalWork only asks for permissions or downloads when you do. Everything stays available later in Settings.",
  "onboarding_setup.office_title": "Work inside Word & Outlook",
  "onboarding_setup.office_body":
    "Draft, review and redline with the agent right next to your document — as tracked changes in Word.",
  ...
  "onboarding_setup.dictation_title": "Dictate anywhere",
  "onboarding_setup.dictation_body":
    "Speak instead of typing — into Word, Outlook, or any app. Transcribed on this device and pasted at your cursor.",
  "onboarding_setup.dictation_enable": "Turn on dictation",
  "onboarding_setup.dictation_ready": "Ready — press {shortcut} in any app",
  "onboarding_setup.dictation_ready_generic": "Ready — your dictation shortcut works in any app",
  "onboarding_setup.recording_title": "Record your meetings",
  "onboarding_setup.recording_body":
    "Capture calls and meetings locally and get a transcript with speakers labeled. Nothing is uploaded.",
  "onboarding_setup.recording_enable": "Turn on meeting recording",
  "onboarding_setup.recording_ready": "Ready — open the Recorder when your meeting starts",
  "onboarding_setup.mic_waiting": "Allow microphone access in the system prompt…",
  "onboarding_setup.mic_denied": "Microphone access is turned off for LegalWork.",
  "onboarding_setup.mic_open_settings": "Open System Settings",
  "onboarding_setup.model_preparing": "Preparing the on-device model ({tier}, {size} MB)…",
  "onboarding_setup.skip": "Skip for now",
  "onboarding_setup.continue": "Continue",
