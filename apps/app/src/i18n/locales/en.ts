...
export default {
  "agents.add_choice_agent": "Agent",
  "agents.add_choice_agent_desc": "An AI teammate with its own instructions, model, and safety limits. Available in every local workspace.",
  "agents.add_choice_subagent": "Subagent",
  "agents.add_choice_subagent_desc": "A specialist that other agents delegate work to. Available in every local workspace.",
  "agents.add_choose_desc": "Choose what to add. Workflows are saved as skills; agents and subagents are available in every local workspace.",
  "agents.approval_allow": "Allow",
  "agents.approval_ask": "Ask first",
  "agents.approval_default": "Default",
  "agents.approval_deny": "Never allow",
  "agents.approvals_hint": "Whether the agent may act on its own or must check with you first.",
  "agents.approvals_label": "Approvals",
  "agents.badge_agent": "Agent",
  "agents.badge_subagent": "Subagent",
  "agents.create_button": "Create agent",
  "agents.created": "Agent created.",
  "agents.delete_confirm": "Delete",
  "agents.delete_message": "Delete “{name}”? This removes it from every local workspace.",
  "agents.delete_title": "Delete agent",
  "agents.deleted": "Agent deleted.",
  "agents.deleting": "Deleting...",
  "agents.description_label": "Description (when to use it)",
  "agents.description_placeholder": "Reviews diligence documents and flags unusual terms.",
  "agents.dialog_edit_desc": "Changes apply to every local workspace after a quick engine reload.",
  "agents.dialog_edit_title": "Edit {name}",
  "agents.dialog_new_desc": "Describe the role, pick a model, and set what the agent may do. Available in every local workspace.",
  "agents.dialog_new_title": "New agent",
  "agents.mode_all": "Primary and subagent",
  "agents.mode_label": "Runs as",
  "agents.mode_primary": "Primary — users can chat with it",
  "agents.mode_subagent": "Subagent — other agents delegate to it",
  "agents.model_default": "Default model",
  "agents.model_label": "Model",
  "agents.name_hint": "Lowercase letters, numbers, and dashes. Saved for every local workspace as {path}.",
  "agents.name_label": "Name",
  "agents.permission_bash": "Terminal commands",
  "agents.permission_edit": "Editing files",
  "agents.permission_webfetch": "Fetching web pages",
  "agents.prompt_label": "Instructions (role prompt)",
  "agents.prompt_placeholder": "You are a diligence reviewer for a law firm.\n\nWhen given documents, you...",
  "agents.saved": "Agent saved.",
  "agents.saving": "Saving...",
  "agents.section_empty": "No agents yet — use “Add workflow” and choose Agent or Subagent.",
  "agents.section_title": "Agents",
  "agents.temperature_hint": "0 = focused and repeatable, 2 = more creative.",
  "agents.temperature_label": "Temperature (optional)",
  "agents.temperature_placeholder": "Model default",
  "agents.tool_bash": "Run terminal commands",
  "agents.tool_edit": "Edit files",
  "agents.tool_patch": "Patch files",
  "agents.tool_read": "Read files",
  "agents.tool_webfetch": "Fetch web pages",
  "agents.tool_write": "Create files",
  "agents.tools_label": "Tools",
