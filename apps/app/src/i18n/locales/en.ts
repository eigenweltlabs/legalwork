...
export default {
  ...
  "fusion.not_configured": "Fusion mode is not configured. Choose the fusion models in Settings → AI Models.",
  "fusion.panel_title": "Fusion",
  "fusion.phase_candidates": "Running candidate models…",
  ...
  "fusion.settings_desc": "Run every prompt on up to three models in parallel, then let a fusion model merge their answers into one. Turn it on per chat with the Fusion button next to the model picker.",
  "fusion.settings_footnote": "The candidate models answer independently in parallel; the fusion model reviews their answers and writes the final reply. At least one candidate model and the fusion model are required.",
  "fusion.settings_fusion_model": "Fusion model (merges the candidate answers)",
  "fusion.settings_model_slot": "Candidate model {index}",
  ...
  "fusion.toggle_on": "Turn on fusion mode: run this chat on multiple models and fuse their answers",
