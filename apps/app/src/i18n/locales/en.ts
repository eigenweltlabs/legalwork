...
export default {
  ...
  "mcp.auth.client_registration_required": "This provider requires a registered OAuth app. Configure its client ID and any required client secret, then sign in again.",
  ...
  "mcp.auth.reload_notice": "For this to take effect, LegalWork needs to refresh the worker service. This can interrupt a running session.",
  "mcp.auth.reload_remote_confirm": "For this to take effect, LegalWork needs to refresh the worker service. This might stop your running session. Continue?",
  ...
  "learnings.eyebrow": "Learnings · Private preview",
  "learnings.headline": "Own your firm's intelligence",
  "learnings.subhead": "Your firm's own models, learned on your matters, improving every week.",
  "learnings.card1_title": "Data structuring & Benchmarks",
  "learnings.card1_desc":
    "We extract the firm's tacit knowledge from your matters, redlines, and comments: partner preferences, drafting style, negotiation playbooks, and review standards.",
  "learnings.card2_title": "Post learning",
  "learnings.card2_desc":
    "A specialist model per practice area, learned on your work and benchmarked against open baselines. Weights your firm owns.",
  "learnings.card3_title": "Continual learning",
  "learnings.card3_desc":
    "Signals from real work, like corrections, rewrites, and missed context, become verifiable tasks that continual learn your models and roll out.",
  ...
  "learnings.talk_with_researcher": "Talk with Researcher",
  ...
  "mcp.desc_ironclad": "Contract lifecycle management: search and analyze contracts in Ironclad.",
  ...
  "mcp.desc_courtlistener": "Federal and state case law, dockets, and opinions from CourtListener.",
  ...
  "mcp.desc_everlaw": "Ediscovery and litigation document review from Everlaw.",
  ...
  "learnings.signals": "Signals",
  "learnings.tasks": "Tasks",
  "learnings.continual_learn": "Continual learn",
  "learnings.rollout": "Rollout",
  "learnings.details": "Details",
  "learnings.run": "Run",
  "learnings.runs": "Runs",
  "learnings.title": "Learnings",
  "learnings.ma": "M&A",
  "learnings.employment": "Employment",
  "learnings.litigation": "Litigation",
