...
export default {
  ...
  "word_addin.empty_selection": "Select some text in the document first.",
  "word_addin.empty_document": "The document has no text yet.",
  "word_addin.no_reply": "No assistant reply to insert yet.",
  "word_addin.inserted": "Inserted into the document.",
  "word_addin.selection_context_label": "Selected text from the Word document:",
  "word_addin.document_context_label": "Text of the Word document:",
  "word_addin.context_truncated": "(The document was truncated because it is very long.)",
