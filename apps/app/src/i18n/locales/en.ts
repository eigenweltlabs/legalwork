...
export default {
  ...
  "config.server_section_desc": "Connect to an LegalWork server. Use the URL plus a collaborator or owner token from your server admin.",
  ...
  "dashboard.create_remote_workspace_subtitle": "Save an LegalWork server as a workspace.",
  ...
  "den.auto_reconnect_hint": "Finish auth in your browser and LegalWork will reconnect here automatically.",
  ...
  "den.cloud_section_title": "LegalWork Cloud",
  "den.cloud_sleep_hint": "Sign in to LegalWork Cloud to keep your tasks alive even when your computer sleeps.",
  "den.cloud_signed_in_desc": "You are signed in and ready to use LegalWork Cloud.",
  "den.cloud_workers_hint": "Open workers directly into LegalWork using the same remote-connect flow the app already uses elsewhere.",
  ...
  "den.error_no_token": "Desktop sign-in completed, but LegalWork Cloud did not return a session token.",
  "den.error_open_worker": "Failed to open {name} in LegalWork.",
  "den.error_open_worker_fallback": "Failed to open {name}.",
  "den.error_paste_valid_code": "Paste a valid LegalWork sign-in link or one-time sign-in code.",
  "den.error_signin_failed": "Failed to complete LegalWork Cloud sign-in.",
  ...
  "den.signin_link_hint": "If your browser doesn't bounce back into LegalWork automatically, paste the sign-in link or one-time code from LegalWork Cloud here.",
  "den.signin_link_label": "Sign-in link or one-time code",
  "den.signin_link_placeholder": "openwork://den-auth?... or pasted code",
  "den.signin_title": "Sign in to LegalWork Cloud",
  "den.signing_in": "Finishing LegalWork Cloud sign-in...",
  "den.signing_out": "Signing out...",
  "den.status_base_url_updated": "Updated the Cloud control plane URL. Sign in again to continue.",
  "den.status_browser_signin": "Finish signing in in your browser to connect LegalWork.",
  "den.status_browser_signup": "Finish account creation in your browser to connect LegalWork.",
  "den.status_cloud_signed_in_as": "Connected LegalWork Cloud as {email}.",
  "den.status_cloud_signin_done": "Connected LegalWork Cloud.",
  ...
  "den.status_opened_worker": "Opened {name} in LegalWork.",
  "den.status_signed_in_as": "Signed in as {email}.",
  "den.status_signed_out": "Signed out and cleared your LegalWork Cloud session on this device.",
  "den.sync": "Sync",
  ...
  "identities.connect_server_desc": "Identities are available when you are connected to an LegalWork host.",
  "identities.connect_server_title": "Connect to an LegalWork server",
  ...
  "mcp.toggle_requires_server": "Connect to an LegalWork server to enable or disable MCPs.",
  ...
  "mcp.quick_connect_openwork_admin_desc": "Read-only Den analytics for LegalWork platform admins: growth, retention, company lookups, and ad-hoc queries. Requires an allowlisted admin account. Try: \"What's our weekly signup growth?\"",
  "mcp.quick_connect_openwork_admin_title": "LegalWork Admin Analytics",
  ...
  "mcp.quick_connect_openwork_cloud_title": "LegalWork Cloud Control",
  "mcp.quick_connect_openwork_ui_desc": "Let agents see and drive the LegalWork app. Navigate sessions, type into the composer, open settings. Try: \"Take a snapshot of what I see\" or \"Create a new session and type hello.\"",
  "mcp.quick_connect_openwork_ui_title": "LegalWork UI Control",
  ...
  "session.share_openwork_workers_only": "Share service links are available for LegalWork workers.",
  ...
  "settings.debug_openwork_server_version": "LegalWork server: {version}",
  ...
  "settings.open_deeplink_desc": "Paste an LegalWork deeplink or share URL to open it.",
  ...
  "settings.openwork_config_sidecar_desc": "Local LegalWork server (Bun) that hosts approvals, audit, and OpenCode lifecycle.",
  "settings.openwork_diagnostics_title": "LegalWork server diagnostics",
  "settings.openwork_server_desc": "Session control plane for app sync, workers, and remote",
  "settings.openwork_server_label": "LegalWork server",
  ...
  "settings.reset_openwork_title": "Reset LegalWork + OpenCode state",
  ...
  "settings.restart_openwork_server": "Restart LegalWork server",
  ...
  "settings.tab_description_appearance": "Adjust how LegalWork looks across desktop, system theme, and app frame.",
  ...
  "settings.environment.apply_confirm_body": "LegalWork will restart local agents so they can use the latest environment. Running local tasks may stop.",
  ...
  "settings.environment.validation_reserved": "OPENWORK_ and OPENCODE_ names are managed by LegalWork/OpenCode.",
  ...
  "share_skill_destination.connect_remote_hint": "Attach an LegalWork host, then choose it from the list to import this skill.",
  ...
  "skills.add_openwork_hub": "Add LegalWork Hub",
  ...
  "skills.share_option_team_desc": "Add this skill to your active LegalWork Cloud organization.",
  ...
  "skills.share_team_permissions_intro": "Upload this skill to your active LegalWork Cloud organization and decide who can see it.",
  ...
  "skills.share_team_sign_in_hint": "LegalWork Cloud opens in your browser. Return here after signing in.",
  ...
  "status.openwork_ready": "LegalWork Ready",
