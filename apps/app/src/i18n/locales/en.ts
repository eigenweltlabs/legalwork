...
export default {
  ...
  "settings.tab_firm_hub": "Firm Hub",
  "settings.tab_description_firm_hub": "Workflows, integrations and presets your firm shares across Eigenwelt.",
  ...
  "firm_hub.locked_title": "Firm Hub is part of your Eigenwelt subscription",
