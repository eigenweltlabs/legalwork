...
export default {
  ...
  "account.use_api_key": "Use an API key",
  "account.api_key_hint": "Paste an Eigenwelt API key to connect without the browser sign-in.",
  "account.api_key_placeholder": "Eigenwelt API key",
  ...
  "account.no_models": "You're signed in, but the Eigenwelt gateway is serving no models yet. Add models on the platform, then use Refresh models — no need to sign in again.",
  "account.models_count": "{count} models",
  "account.refresh_models": "Refresh models",
  "account.refresh_models_loaded": "Loaded {count} models.",
  "account.refresh_models_uptodate": "Models are up to date ({count}).",
  "account.refresh_models_none": "The gateway is serving no models yet.",
  "account.refresh_models_failed": "Could not refresh models.",
  ...
  "recorder.tier_premium_locked": "Premium",
  "recorder.tier_premium_unlock": "Premium plan",
  "recorder.tier_premium_unlock_hint": "The Premium transcription model is part of a paid plan. It will unlock automatically once your plan is active.",
  "premium_upsell.eyebrow": "Eigenwelt Plus",
  "premium_upsell.headline": "Unlock Plus for €25 per user / month",
  "premium_upsell.intro": "Included on Plus, for every seat in your firm:",
  ...
  "premium_upsell.eu_body": "Included Eigenwelt Model API usage on EU-resident infrastructure that keeps no prompts or outputs.",
  ...
  "premium_upsell.cta": "Upgrade to Plus",
  ...
  "onboarding_setup.model_body":
    "Record calls and dictate on device. We recommend the {tier} model for this computer.",
  "onboarding_setup.model_download": "Download {tier} model",
  "onboarding_setup.model_installed": "{tier} model ready",
