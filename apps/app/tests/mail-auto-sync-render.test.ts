...
test('actual renderer automatically displays sync progress, downloaded inbox messages and retry without navigation',async()=>{
 ...
 try{
  ...
  await buildBrowserFixture({entrypoints:[entry],outdir:root,alias:{'@':join(appRoot,'src')},minify:true});
