import {z} from 'zod';
export const qualificationTransportCodeSchema=z.enum(['invalid_input','invalid_response','response_too_large','raw_too_large','access_token_rejected','reconsent_required','forbidden','rate_limited','quota_exceeded','transient','not_found','request_rejected','timeout','cancelled','consumer_failed']);
