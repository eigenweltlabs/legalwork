...
const requiredColumns: Record<string, string[]> = {
  ...
  mail_imap_runs:["account_id","generation","revision","state","retry_at","error","failures","discovered","capabilities_json"],
  mail_imap_folders:["account_id","path","delimiter","special_use","selectable","selected","uid_validity","uid_next","after_uid","uid_span","done","generation"],
  mail_imap_messages:["account_id","message_key","internal_date"],
