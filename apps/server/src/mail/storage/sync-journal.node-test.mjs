...
test("v2 upgrade is additive and atomic; future versions and failed DDL remain unchanged", async () => fixture(({ db }) => {
 removeLaterMailSchema(db,2);db.exec("DROP VIEW mail_account_access; DROP TABLE mail_graph_mailboxes; DROP TABLE mail_saved_searches; DROP TRIGGER mail_extraction_manifest_insert; DROP TRIGGER mail_extraction_manifest_update; DROP TRIGGER mail_extraction_changed; DROP TABLE mail_attachment_extractions");for(const row of db.all("SELECT name FROM sqlite_schema WHERE type='trigger' AND name GLOB 'mail_local_*'"))db.exec('DROP TRIGGER "'+row.name+'"');db.exec('DROP TABLE mail_local_action_drafts; DROP TABLE mail_local_draft_parts; DROP TABLE mail_local_draft_versions; DROP TABLE mail_local_drafts; DROP TABLE mail_imap_folders; DROP TABLE mail_imap_runs; DROP TABLE mail_imap_messages; DROP TABLE mail_imap_credentials; DROP TRIGGER mail_known_inbox; DROP INDEX mail_folder_role; ALTER TABLE mail_folders DROP COLUMN role; DROP TABLE mail_graph_delta_seen; DROP TABLE mail_graph_delta; DROP TABLE mail_graph_poll; DROP TABLE mail_local_events; DROP TABLE mail_local_event_streams');db.exec("DROP TABLE mail_graph_attachments; DROP TABLE mail_graph_messages; DROP TABLE mail_graph_folder_queue; DROP TABLE mail_graph_runs");
 ...
 db.exec('DROP TABLE mail_search_fts; DROP TABLE mail_search_documents; DROP TABLE mail_search_dirty; ALTER TABLE mail_messages DROP COLUMN is_read');
  db.exec("DROP TRIGGER mail_raw_projection_insert; DROP TRIGGER mail_raw_projection_update; DROP TABLE mail_mime_parts; DROP TABLE mail_mime_projections; DROP TABLE mail_gmail_metadata; DROP TABLE mail_gmail_presence; DROP TABLE mail_gmail_runs; DROP TABLE mail_action_jobs; DROP TABLE mail_account_credentials; DROP TABLE mail_sync_scope_jobs; DROP TABLE mail_sync_jobs; DROP TABLE mail_sync_scopes; UPDATE mail_schema_version SET version=2");
