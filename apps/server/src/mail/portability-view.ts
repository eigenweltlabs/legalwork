...
export const portabilityCommandSchema=z.discriminatedUnion('operation',[
 ...
 z.object({operation:z.literal('mail.portability.abandon'),id:z.string().uuid(),confirmation:z.literal('ABANDON CHECKPOINT')}).strict(),
